...
class Player extends Loghelper {
    ...
    async key_events() {
        ...
        this.keyListenerOff = keypress.listen({ stdin: process.stdin }, throttled_key_events);
    ...
    async listen_for_events() {
        ...
        EE.on('window-settings', showWindow.bind(this, 'settings'));
        EE.on('window-playlist', showWindow.bind(this, 'playlist'));
    ...
    showWindow(window) {
        ...
        if (this.windows[window] && this.offPlayerWindow === false) {
            ...
            // header
            console.log(kleur.bold().yellow(window.toUpperCase()));
            console.log(kleur.bold().yellow(this.borderLine) + '\n');
            ...
            this.windows[window]()
                .then((resp) => {
                    ...
                    // remove all listeners that might not be removed
